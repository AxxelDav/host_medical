...
public class MedicalShiftServiceImpl implements MedicalShiftService {
    ...
    public MedicalShiftServiceImpl(MedicalShiftRepository medicalShiftRepository, SpecializationRepository specializationRepository) {
    ...
    public void createSchedules(LocalDateTime registrationProfessionalDate, Professional professional) {
        //TODO voy 3 meses paa delante con respecto a la fecha actual y en base al turno laboral y al tiempo de consulta persisto en la base de datos (MedicalShift) lo asociado e inicialmente pongo que "NO" en la columna "Tomado"
