...
//    }
//
//    public void validate(String specialization, String month, String locale, String streetNumber, String street, List<WorkingDay> workingDays, String dayshift) throws IllegalArgumentException, DataInconsistencyException {
//
//        if (specializationService.findSpecializationByDescripcion(specialization) == null) {
//            throw new IllegalArgumentException("Especialidad no válida. Debe ser una de las especialidades médicas disponibles.");
//        }
//
//        if (!isValidateMonth(month)) {
//            throw new IllegalArgumentException("Mes ingresado no válido.");
//        }
//
//        if (medicalBranchService.findByLocaleAndNumberAndStreet(locale, streetNumber, street) == null) {
//            throw new IllegalArgumentException("Sucursal ingresada no válida.");
//        }
//
//        if (!isValidateWorkingDay(workingDays)) {
//            throw new IllegalArgumentException("Día/s ingresado no válido.");
//        }
//
//        if (!isValidateDayshift(dayshift)) {
//            throw new IllegalArgumentException("Turno ingresado no válido.");
//        }
//
//    }
//
